      ...
      <Layout>
        <div className="flex items-center justify-center py-24">
          <div className="flex flex-col items-center gap-3">
            ...
            <p className="text-sm text-gray-400 font-medium">Memuat profil...</p>
          </div>
        </div>
      </Layout>
    );
    ...
    return (
      <Layout>
        <div className="flex flex-col items-center justify-center py-24 gap-3">
          ...
          <p className="text-sm font-semibold text-red-400">Data guru tidak ditemukan</p>
        </div>
      </Layout>
    );
  }
                ...
                <div key={item.label}>
                  <div className="flex items-start gap-3 py-3 px-2 rounded-2xl hover:bg-gray-50 transition-colors">
                    <div className={`w-8 h-8 rounded-xl ${item.color} flex items-center justify-center flex-shrink-0 mt-0.5`}>
                      <Icon size={14} className={item.iconColor} strokeWidth={2.3} />
                    </div>
                    <div className="flex-1 min-w-0">
      ...
      {showPasswordModal && (
        <div className="fixed inset-0 z-50 bg-black/40 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="w-full max-w-md bg-white rounded-3xl p-6 shadow-2xl">
            ...
            <h2 className="text-2xl font-black text-[#1d2433] mb-1">Ubah Password</h2>
            <p className="text-sm text-gray-400 mb-6">Pastikan password baru mudah diingat</p>

            <div className="space-y-4">

              <div>
                <label className="text-xs font-bold text-gray-400 uppercase">Password Lama</label>
                <input
                  type="password"
                  value={oldPassword}
