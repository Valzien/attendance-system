...
export default function Profile() {
  ...
  const infoItems = [

    {
      icon: CreditCard,
      label: "NIS / NISN",
      value: `${profile.nis} / ${profile.nisn}`,
      color: "bg-[#cbeeff]",
...

    {
      icon: Phone,
      label: "WA Wali",
      value: profile.no_wa_ortu || "-",
      color: "bg-[#ffc8d0]",
      iconColor: "text-[#cf3450]",
    },
  ...
  const initials = profile.nama_siswa
    ? profile.nama_siswa
        .split(" ")
        .slice(0, 2)
        .map((w) => w[0])
