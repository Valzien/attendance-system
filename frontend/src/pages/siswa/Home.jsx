          ...
          <div className="flex flex-col sm:flex-row items-center gap-0">
            <div className="w-full sm:w-64 bg-gradient-to-br from-[#e1f1eb] to-[#fdf1e1] flex items-end justify-center pt-6 sm:pt-0 sm:h-48 flex-shrink-0">
              <img
                src={heroImg}
                alt="Students"
                className="w-48 sm:w-full object-contain"
              />
            </div>
            <div className="flex-1 p-6">
              ...
              <h1 className="text-[22px] font-black text-[#1d2433] leading-tight">
                {name || "Siswa"}
              </h1>
              {kelas && (
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                <div
                  className={`flex items-center gap-1.5 text-[11px] font-bold px-3 py-1.5 rounded-xl ${absenMasukOpen ? "bg-[#c7f5d8] text-[#2b8a57]" : "bg-gray-100 text-gray-400"}`}
                >
                  {absenMasukOpen ? (
                ...
                <div
                  className={`flex items-center gap-1.5 text-[11px] font-bold px-3 py-1.5 rounded-xl ${absenKeluarOpen ? "bg-[#c7f5d8] text-[#2b8a57]" : "bg-gray-100 text-gray-400"}`}
                >
                  {absenKeluarOpen ? (
                    <CheckCircle2 size={12} />
                  ) : (
                  ...
                  Absen Keluar{" "}
                  {absenKeluarOpen ? "Dibuka" : jamPulang.replace(":", ".")}
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          >
            <div className="w-9 h-9 rounded-xl bg-white/50 flex items-center justify-center">
              <ArrowDownRight
                size={20}
                className="text-[#9c8421]"
                strokeWidth={2.5}
              />
            </div>
            <div>
              <h2 className="text-[16px] font-black text-[#9c8421] leading-tight">
                Absen Masuk
              </h2>
              <p className="text-[11px] font-bold text-[#bfa846] mt-0.5">
                06.45 – 07.45
              </p>
            </div>
            {!absenMasukOpen && (
          ...
          >
            <div className="w-9 h-9 rounded-xl bg-white/50 flex items-center justify-center">
              <ArrowUpLeft
                size={20}
                className="text-[#2a8742]"
                strokeWidth={2.5}
              />
            </div>
            <div>
              <h2 className="text-[16px] font-black text-[#2a8742] leading-tight">
                Absen Keluar
              </h2>
              <p className="text-[11px] font-bold text-[#4eb368] mt-0.5">
                {jamPulang.replace(":", ".")}
              </p>
            </div>
            {!absenKeluarOpen && (
        ...
        <div className="grid grid-cols-3 gap-3">
          {[
            ...
            >
              ...
              <span className={`text-[11px] font-black leading-tight ${text}`}>
                {label}
              </span>
            </Link>
          ))}
